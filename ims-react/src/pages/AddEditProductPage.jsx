...
const AddEditProductPage = () => {
  ...
  const [stockQuantiy, setStokeQuantiy] = useState("");
      ...
      if (productId) {
        ...
        try {
          ...
          if (productData.status === 200) {
            ...
            setStokeQuantiy(productData.product.stockQuantiy);
  ...
  const handleSubmit = async (e) => {
    ...
    formData.append("stockQuantiy", stockQuantiy);
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-group">
            ...
            <input
              type="number"
              value={stockQuantiy}
              onChange={(e) => setStokeQuantiy(e.target.value)}
              required
            />
          </div>
